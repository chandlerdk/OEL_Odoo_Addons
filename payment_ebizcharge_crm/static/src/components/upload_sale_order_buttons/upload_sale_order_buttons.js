...
class UploadSaleOrderButtons extends ListRenderer {
    ...
    async UploadSaleOrderUpload (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await this.rpc("/web/dataset/call_kw/upload.sale.orders/upload_orders", {
    ...
    async UploadSaleOrderExportList (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await this.rpc("/web/dataset/call_kw/upload.sale.orders/export_orders", {
                model: 'upload.sale.orders',
    ...
    async UploadSaleOrderClearLogs (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await this.rpc("/web/dataset/call_kw/upload.sale.orders/clear_logs", {
                model: 'upload.sale.orders',
                method: 'clear_logs',
                args : [[parseInt(params['id'])]],
                kwargs: {"values":res_ids}
    ...
    async UploadSaleOrderExportLogs (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await this.rpc("/web/dataset/call_kw/upload.sale.orders/export_logs", {
                model: 'upload.sale.orders',
                method: 'export_logs',
                args : [[parseInt(params['id'])]],
                kwargs: {"values":res_ids}
